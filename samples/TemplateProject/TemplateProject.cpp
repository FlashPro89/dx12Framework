...
TemplateProject::TemplateProject(std::string name,
...
void TemplateProject::createSRVTex2D(ID3D12Resource* pResourse, UINT heapOffsetInDescriptors)
{
...
bool TemplateProject::initialize()
{
	if (!initDefault())
		return false;
	if (!initInput())
...
bool TemplateProject::beginCommandList()
{
...
bool TemplateProject::populateCommandList()
{
    // Set necessary state.
...
bool TemplateProject::endCommandList()
{
...
void TemplateProject::executeCommandList()
{
...
bool TemplateProject::executeCommandListAndPresent()
{
...
bool TemplateProject::createRootSignatureAndPSO()
{
